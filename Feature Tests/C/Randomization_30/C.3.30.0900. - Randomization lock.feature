Feature: User Interface: The system shall ensure users with Randomization Setup rights lock randomization models and allocation table while in production mode.
  As a REDCap end user
  I want to see that Randomization is functioning as expected

Scenario: C.3.30.0900.0100. Normal user cannot modify setup in production.  C.3.30.0900.0200. Admin user unable to revert project to development. 
