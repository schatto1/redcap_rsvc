Feature: Control Center: The system shall allow optional adding of a custom message on the e-Consent Framework setup page of every project.
    ...
    Scenario: A.3.24.1100.100 Custom message on the e-Consent Framework setup page of every project
        ...
        When I enter "My custom message" into the input field labeled "Custom message for e-Consent Framework settings (optional) "
    ...
    Scenario: Verify institutional custom message in framework
        ...
        And I select '"Participant Consent" (participant_consent)' on the dropdown field labeled "Enable e-Consent for a Survey"
     
        Then I should see a dialog containing the following text: "Enable e-Consent" 
