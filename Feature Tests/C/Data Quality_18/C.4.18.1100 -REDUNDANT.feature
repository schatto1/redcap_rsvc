Feature: User Interface: The system shall support validating the unique event name used in custom rules for longitudinal projects.
    ...
    Scenario: C.4.18.1100.100 Data quality rule creation for longitudinal projects.
    
    This feature test is REDUNDANT and can be viewed in C.4.18.200.100 Data quality rule creation.
